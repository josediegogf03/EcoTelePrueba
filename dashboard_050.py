...
# Removes specific CSS classes from the overview section.
st.markdown(
    """
<style>
...
def render_dynamic_charts_section(df: pd.DataFrame):
    ...
    <div class="instructions-container">
        ...
        <div class="instructions-content">
            ...
            <p><strong>Currently</strong> graphs visibility is reduced when auto refresh is enabled.</p>
        </div>
    </div>
    """,
        unsafe_allow_html=True,
...
def main():
    ...
    with st.sidebar:
        ...
        with col2:
            if st.button("🛑 Disconnect", use_container_width=True):
                ...
                st.session_session_state.is_auto_refresh = False
                st.rerun()
    ...
    # Ingests new telemetry messages from the subscriber and updates the DataFrame.
    ...
    if (
        ...
        if new_messages:
            ...
            # Truncates the DataFrame to the maximum number of data points.
    ...
    # Implements auto-refresh functionality based on user settings.
    if (
